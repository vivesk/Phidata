...
multi_ai_agent = Agent(
    ...
    instructions=[
        "Coordinate responses from all agents to ensure comprehensive answers.",
        "Always include sources and use tables or bullet points to structure the output.",
        "Provide stock price, company news, and analyst recommendations for financial queries.",
        "Ensure web search results are precise, reliable, and properly cited."
    ],
    model=Groq(id="llama-3.3-70b-versatile", temperature=0.1),
    show_tool_calls=True,
    markdown=True,
...
multi_ai_agent.print_response("Summarize analyst recommendations, latest news, and stock price for costco", stream=True)
